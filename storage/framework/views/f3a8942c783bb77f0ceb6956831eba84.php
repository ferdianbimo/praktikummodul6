...
unset($__errorArgs, $__bag); ?>"
                            type="text" name="firstName" id="firstName" value="<?php echo e(old('firstName')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            type="text" name="lastName" id="lastName" value="<?php echo e(old('lastName')); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                            name="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>" type="text"
                            name="age" id="age" value="<?php echo e(old('age')); ?>" placeholder="Enter Age">
                        <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bimomodul4\resources\views/employee/create.blade.php ENDPATH**/ ?>